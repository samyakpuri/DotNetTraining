...
namespace EmployeeManagementLib
{
    ...
    public partial class EmployeeManagementEntities : DbContext
    {
        ...
        public virtual ObjectResult<employeeSelect_Result> employeeSelect(string fname, string lname, Nullable<int> department, Nullable<int> project)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<employeeSelect_Result>("employeeSelect", fnameParameter, lnameParameter, departmentParameter, projectParameter);
        }
    }
}
